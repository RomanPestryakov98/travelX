(() => {
    ...
    function menuInit() {
        if (document.querySelector(".icon-menu")) document.addEventListener("click", (function(e) {
            ...
            if (document.documentElement.classList.contains("menu-open") && e.target.classList.contains("overlay")) document.documentElement.classList.toggle("menu-open");
        }));
    }
    ...
    function initSliders() {
        if (document.querySelector(".swiper__slider")) new swiper_core_Swiper(".swiper", {
            ...
            loop: true,
            pagination: {
                el: ".bottom-header__fraction",
                type: "fraction",
                renderFraction: function(currentClass, totalClass, index, total) {
                    return '<span class="' + currentClass + '">0 ' + index + " </span>" + "<span>" + "/" + "</span>" + '<span class="' + totalClass + '">0 ' + total + " </span>";
                }
            },
            scrollbar: {
                el: ".swiper-scrollbar"
    ...
    const list = document.querySelectorAll(".body-mobile__item");
    if (list.length) list.forEach(((item, index) => {
        item.classList.add(`body-mobile__item_${index + 1}`);
    }));
    window["FLS"] = true;
    isWebp();
    menuInit();
